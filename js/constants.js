...
const ABIS = {
	...
	MoonMoonzLandz: [
		"function totalSupply() view returns(uint256)",
		"function saleState() view returns(uint256)",
		"function claimFree(uint256 amount, bytes32[] calldata proof)",
		"function claimWithWATER(uint256 amount)",
		"function claimWithETH(uint256 amount) payable",
		"function balanceOf(address) view returns(uint256)",
		"function tokenOfOwnerByIndex(address, uint256) view returns(uint256)",
		"function tokenURI(uint256) view returns(string)",
		"function priceETH() view returns(uint256)",
		"function priceWATER() view returns(uint256)",
	],
};
